...
contract SashaV2BaseTest is Test {
    /// State Variable
    ...
    // Contract
    address internal Balancer = 0xBA12222222228d8Ba445958a75a0704d566BF2C8;
    ...
    // Modifier
    modifier validation() {
        uint256 tokensBefore = ERC20(DAI).balanceOf(address(this));
        _;
        uint256 tokensAfter = ERC20(DAI).balanceOf(address(this));
